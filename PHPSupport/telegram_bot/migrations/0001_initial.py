# Generated by Django 2.2.24 on 2023-02-16 15:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clarification', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='telegram_bot.Clarification', verbose_name='clarification')),
            ],
        ),
        migrations.CreateModel(
            name='Subcontractor',
            fields=[
                ...
                ('request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='telegram_bot.Request', verbose_name='subcontractor request')),
            ],
        ),
        migrations.CreateModel(
            name='Client',
            fields=[
                ...
                ('request', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='telegram_bot.Request', verbose_name='client request')),
            ],
        ),
    ]
